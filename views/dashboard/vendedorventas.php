<?php
/**
 * VISTA: Mis Ventas (Vendedor)
 * Cargada por: controllers/vendedorventascontroller.php?accion=index
 * Variables: $ventas, $clientes, $productos, $total, $totalMes, $alert
 */
if (!isset($ventas)) {
    header("Location: /inventory/controllers/vendedorventascontroller.php?accion=index");
    exit;
}
...
<div class="gap">
    ...
    <div class="page-header">
        <div>
            <h2><i class="fas fa-cash-register" style="margin-right:.5rem;opacity:.8;"></i>Mis Ventas</h2>
    ...
    <div class="g3">
        <div class="mini-stat">
            ...
            <div>
                ...
                <div class="mini-stat-lbl">Mis ventas</div>
            </div>
        </div>
        <div class="mini-stat">
        ...
        <div class="mini-stat">
            ...
            <div>
                ...
                <div class="mini-stat-lbl">Clientes disponibles</div>
            </div>
        </div>
    </div>
...
<div class="modal-overlay" id="modalCrear">
    <div class="modal-box">
        ...
        <form action="/inventory/controllers/vendedorventascontroller.php?accion=crear" method="POST" id="formCrearVenta">
...
function actualizarCantidad(idx, val) {
    ...
    if (cantidad > carrito[idx].stock) cantidad = carrito[idx].stock;
...
function verDetalle(idVenta) {
    ...
    fetch('/inventory/controllers/vendedorventascontroller.php?accion=detalle&id=' + idVenta)
...
function guardarNuevoCliente() {
    ...
    fetch('/inventory/controllers/vendedorventascontroller.php?accion=crearCliente', {
        method: 'POST',
        body: formData
    })
    .then(function(r) { return r.json(); })
